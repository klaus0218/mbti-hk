// MBTI Preview Content for all 16 types (EN, ZH, ZH-CN)
...
const mbtiPreviewContent = {
  "INTJ": {
    ...
    "zh-CN": {
      "title": "建筑师 - 战略大师",
      "summary": "作为INTJ，你是一个具有战略远见的人，拥有识别模式和创建综合系统的卓越能力。你的分析思维和独立性格使你成为一个自然的问题解决者，在长期规划和复杂分析方面表现出色。",
      "keyInsights": [
        "具有卓越模式识别能力的大师级战略家",
        "重视能力和效率的独立思考者",
        "具有创新方法的自然问题解决者"
      ],
      "careerPath": "你的分析技能和战略思维使你很适合从事战略规划、研究、工程和咨询工作。在能够发展长期愿景和实施系统解决方案的职位中表现出色。考虑从事数据科学、建筑、项目管理或创业，这些领域高度重视你看到大局和创建高效系统的能力。",
      "friendshipCompatibility": "你更喜欢与智力刺激的个人建立深刻、有意义的联系，他们尊重你对独立的需求。你重视能够进行深思熟虑讨论并欣赏你独特观点的朋友。虽然你的朋友可能较少，但你建立的关系都建立在相互尊重和智力相容性的基础上。",
      "romanticCompatibility": "在恋爱关系中，你寻求能够进行智力刺激和深度对话的伴侣。你重视独立性，需要空间来处理你的想法。你理想的伴侣理解你的分析本质，并欣赏你对生活的战略方法。你最适合与能够平衡你对独处需求和情感联系的类型相处。",
      "mentalHealthInsights": "你过度思考和分析的倾向有时会导致压力和焦虑。你可能会经历完美主义和对自己和他人的高期望。练习自我同情并认识到不是所有事情都需要优化是很重要的。考虑正念技巧来帮助你保持当下并减少过度思考。",
      "selfImprovement": "专注于发展你的情商和人际交往技能。练习积极倾听和更开放地表达你的感受。学会平衡你对完美的需求与对不完美的接受。考虑发展允许你在较少结构化的方式中使用你的创造力和战略思维的爱好。",
      "coreAnalysisPreview": "你的INTJ人格类型代表了最稀有和最具智力天赋的组合之一。你拥有通过系统和模式的镜头看世界的独特能力，使你特别善于识别低效率并创建创新解决方案。你的战略思维允许你提前计划几个步骤，而你的独立性格给你追求非常规道路的信心。在专业环境中，你通常是能够识别复杂问题根本原因并开发其他人可能错过的综合解决方案的人。你对关系的分析方法意味著你重视深刻、有意义的联系，而不是表面的社交互动。你对自己和他人有很高的标准，这有时会创造挑战，但也会推动你在所做的一切中追求卓越。",
      "callToAction": "解锁你的完整INTJ人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "建筑师 - 战略大师",
      "summary": "作为INTJ，你是一个具有战略远见的人，拥有识别模式和创建综合系统的卓越能力。你的分析思维和独立性格使你成为一个自然的问题解决者，在长期规划和复杂分析方面表现出色。",
  ...
  "INTP": {
    ...
    "zh-CN": {
      "title": "思考者 - 创新分析师",
      "summary": "作为INTP，你是一个杰出的理论思考者，对事物如何运作有著永不满足的好奇心。你的逻辑思维和创新方法使你成为一个自然的问题解决者，在理解复杂系统和开发创意解决方案方面表现出色。",
      "keyInsights": [
        "具有创新问题解决能力的杰出理论思考者",
        "善于理解复杂系统的自然分析师",
        "具有独特视角的创意问题解决者"
      ],
      "careerPath": "你的分析思维和创新思维使你很适合从事研究、开发和分析工作。在能够探索复杂问题和开发理论框架的职位中表现出色。考虑从事科学研究、软件开发、哲学或咨询，这些领域高度重视你跳出框框思考和解决复杂问题的能力。",
      "friendshipCompatibility": "你更喜欢与能够进行深度理论讨论的人建立智力联系。你重视欣赏你独特观点并能够挑战你思维的朋友。虽然你最初可能显得保守，但你与那些理解你对智力刺激需求并尊重你对生活的分析方法的人形成深厚的联系。",
      "romanticCompatibility": "在恋爱关系中，你寻求能够进行智力刺激和深度对话的伴侣。你重视独立性，需要空间来处理你的想法。你理想的伴侣理解你的分析本质，并欣赏你的创新思维。你最适合与能够平衡智力联系和情感理解的类型相处。",
      "mentalHealthInsights": "你过度思考和分析的倾向有时会导致分析瘫痪和压力。由于想要考虑所有可能性，你可能会经历决策困难。练习决策并认识到不是所有问题都需要完美解决方案是很重要的。考虑帮助你从分析转向行动的技巧。",
      "selfImprovement": "专注于发展你的情商和人际交往技能。练习表达你的感受并在情感层面上与他人联系。学会平衡你对理论理解的需求与实际应用。考虑发展允许你在较少结构化的方式中使用你的创造力的爱好。",
      "coreAnalysisPreview": "你的INTP人格类型代表了最具智力天赋和创新的组合之一。你拥有通过逻辑和理论的镜头看世界的独特能力，使你特别善于理解复杂系统和开发创新解决方案。你的理论思维允许你探索抽象概念并识别其他人可能错过的模式，而你的创新思维给你从完全新角度处理问题的能力。在专业环境中，你通常是能够将复杂问题分解为可理解的组件并开发其他人没有考虑过的创意解决方案的人。你对关系的分析方法意味著你重视智力相容性和深度理解，而不是表面联系。你有一种自然的好奇心，驱使你不断学习和探索新想法，这使你在任何需要创新思维和问题解决的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整INTP人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "思考者 - 创新分析师",
      "summary": "作为INTP，你是一个杰出的理论思考者，对事物如何运作有著永不满足的好奇心。你的逻辑思维和创新方法使你成为一个自然的问题解决者，在理解复杂系统和开发创意解决方案方面表现出色。",
  ...
  "INFJ": {
    ...
    "zh-CN": {
      "title": "提倡者 - 富有同情心的远见者",
      "summary": "作为INFJ，你是深度同理心和战略思维的罕见组合。你对人们的直觉理解和强烈的使命感使你成为一个自然的顾问和倡导者，能够激励他人发挥全部潜力。",
      "keyInsights": [
        "深度同理心，具有卓越的读人技能",
        "具有强烈使命感的战略思考者",
        "他人的自然顾问和倡导者"
      ],
      "careerPath": "你的同理心和战略思维的结合使你很适合从事帮助他人的职业。在咨询、心理学、社会工作、教学和人力资源方面表现出色。考虑从事非营利工作、倡导、写作或咨询，这些领域你可以利用你理解人们和创造有意义变化的能力。",
      "friendshipCompatibility": "你与欣赏你同理心并分享你价值观的人建立深刻、有意义的友谊。你更重视关系的质量而不是数量，并深深投资于你关心的人。你最舒适与尊重你独处需求并理解你直觉本质的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求深刻的情感联系和智力相容性。你重视能够理解你复杂内心世界并欣赏你关怀本质的伴侣。你最适合与能够提供情感稳定性同时尊重你对独立性和个人成长需求的类型相处。",
      "mentalHealthInsights": "你的深度同理心有时会导致情感耗尽和因吸收他人情绪而产生的压力。你可能会经历完美主义和对自己的高期望。练习自我照顾和设定健康界限是很重要的。考虑帮助你管理情感能量和维持情感平衡的技巧。",
      "selfImprovement": "专注于发展实用技能并学会平衡你的理想主义与现实。练习设定界限并在必要时说不。学会平衡你帮助他人的需求与照顾自己的需求。考虑发展允许你表达创造力并与内心自我联系的爱好。",
      "coreAnalysisPreview": "你的INFJ人格类型代表了最稀有和最复杂的组合之一，结合了深度同理心和战略思维。你拥有在深刻层次理解人们的卓越能力，经常在他们之前看到他们的潜力。你的直觉本质允许你读懂字里行间并理解其他人真正在想什么和感受什么。在专业环境中，你通常是能够识别人际问题根本原因并开发解决实际和情感需求的解决方案的人。你对关系的关怀方法意味著你深深投资于你关心的人，经常作为他们成长和幸福的顾问和倡导者。你有强烈的使命感，被对世界产生积极影响的愿望驱使，这使你在任何涉及帮助他人或创造有意义变化的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整INFJ人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "提倡者 - 富有同情心的远见者",
      "summary": "作为INFJ，你是深度同理心和战略思维的罕见组合。你对人们的直觉理解和强烈的使命感使你成为一个自然的顾问和倡导者，能够激励他人发挥全部潜力。",
  ...
  "INFP": {
    ...
    "zh-CN": {
      "title": "调停者 - 理想主义治疗师",
      "summary": "作为INFP，你是一个富有同情心的理想主义者，有著帮助他人和让世界变得更美好的深刻愿望。你的创造精神和强烈的价值观指导你创造有意义的联系并追求你的热情。",
      "keyInsights": [
        "具有强烈个人价值观的富有同情心的理想主义者",
        "寻求真实联系的创造精神",
        "他人的自然治疗师和倡导者"
      ],
      "careerPath": "你的创造力和帮助他人的愿望使你很适合从事艺术和帮助他人的职业。在写作、咨询、教学、社会工作和创意艺术方面表现出色。考虑从事非营利工作、治疗、教育或创意领域，这些领域你可以表达你的价值观并帮助他人。",
      "friendshipCompatibility": "你与分享你价值观并欣赏你真实本质的人建立深刻、有意义的友谊。你更重视质量而不是数量，并深深投资于感觉真实的关系。你最舒适与尊重你独处需求并理解你情感深度的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求深刻的情感联系和共同的价值观。你重视能够理解你复杂内心世界并欣赏你关怀本质的伴侣。你最适合与能够提供情感支持同时尊重你对独立性和个人成长需求的类型相处。",
      "mentalHealthInsights": "你的敏感性和理想主义有时会导致情感压倒和来自世界事件的压力。你可能会经历完美主义和对自己和他人的高期望。练习自我照顾和设定健康界限是很重要的。考虑帮助你管理情感能量和维持平衡的技巧。",
      "selfImprovement": "专注于发展实用技能并学会平衡你的理想主义与现实。练习设定界限并在必要时说不。学会平衡你帮助他人的需求与照顾自己的需求。考虑发展允许你表达创造力并与内心自我联系的爱好。",
      "coreAnalysisPreview": "你的INFP人格类型代表了最理想主义和富有同情心的组合之一，结合了深度同理心和创造性表达。你拥有理解人们情感和动机的卓越能力，经常作为他人安慰和指导的来源。你的创造精神允许你在世界上看到美丽和可能性，而你强烈的价值观指导你做出与你原则一致的决定。在专业环境中，你通常是能够创造有意义联系并通过你真实的方法和对他们幸福的真诚关怀激励他人的人。你的理想主义本质驱使你寻求与你价值观一致并允许你对他人生活产生积极影响的工作。",
      "callToAction": "解锁你的完整INFP人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "调停者 - 理想主义治疗师",
      "summary": "作为INFP，你是一个富有同情心的理想主义者，有著帮助他人和让世界变得更美好的深刻愿望。你的创造精神和强烈的价值观指导你创造有意义的联系并追求你的热情。",
  ...
  "ENTJ": {
    ...
    "zh-CN": {
      "title": "指挥官 - 大胆的领导者",
      "summary": "作为ENTJ，你是一个天生的领导者，具有卓越的战略思维和决心。你的信心和看到大局的能力使你成为一个有效的决策者，能够激励和指导他人走向成功。",
      "keyInsights": [
        "具有卓越战略思维的天生领导者",
        "看到大局的自信决策者",
        "他人的有效激励者和指导者"
      ],
      "careerPath": "你的领导技能和战略思维使你很适合从事执行和管理职位。在商业、创业、咨询和政治方面表现出色。考虑从事企业领导、业务发展、战略规划或公共服务，这些领域你可以利用你的领导和做出战略决策的能力。",
      "friendshipCompatibility": "你更喜欢与智力刺激并能够进行有意义讨论的人建立友谊。你重视尊重你驱动力并能够挑战你思维的朋友。虽然你的亲密朋友可能较少，但你建立的关系都建立在相互尊重和智力相容性的基础上。",
      "romanticCompatibility": "在恋爱关系中，你寻求能够进行智力刺激和深度对话的伴侣。你重视独立性，需要空间来追求你的目标。你理想的伴侣理解你的雄心本质，并欣赏你对生活的战略方法。你最适合与能够平衡智力联系和情感支持的类型相处。",
      "mentalHealthInsights": "你对成功的驱动力和高期望有时会导致压力和倦怠。你可能会经历完美主义和放松困难。练习自我照顾并认识到不是所有事情都需要优化是很重要的。考虑帮助你管理压力和维持工作生活平衡的技巧。",
      "selfImprovement": "专注于发展你的情商和人际交往技能。练习积极倾听和更开放地表达你的感受。学会平衡你对成就的需求与对不完美的接受。考虑发展允许你放松并在个人层面上与他人联系的爱好。",
      "coreAnalysisPreview": "你的ENTJ人格类型代表了最有效和战略性的领导组合之一，结合了自然权威和卓越的规划能力。你拥有看到大局和开发实现目标的综合策略的天生能力。你的信心和决心激励他人跟随你的领导，而你的战略思维允许你识别机会并开发其他人可能错过的计划。在专业环境中，你通常是能够掌控复杂情况并通过明确方向和有效决策指导团队走向成功的人。你的自然领导能力使你在任何需要强有力方向、战略规划和激励他人走向共同目标能力的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ENTJ人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "指挥官 - 大胆的领导者",
      "summary": "作为ENTJ，你是一个天生的领导者，具有卓越的战略思维和决心。你的信心和看到大局的能力使你成为一个有效的决策者，能够激励和指导他人走向成功。",
  ...
  "ENFP": {
    ...
    "zh-CN": {
      "title": "竞选者 - 热情的创新者",
      "summary": "作为ENFP，你是一个热情和富有创造力的人，对生活有著传染性的热情。你与人联系和到处看到可能性的能力使你成为一个自然的激励者和创新者。",
      "keyInsights": [
        "具有传染性热情的热情创新者",
        "到处看到可能性的自然连接者",
        "创意激励者和人际交往者"
      ],
      "careerPath": "你的创造力和人际交往技能使你很适合涉及创新和人际联系的职位。在营销、销售、教学、咨询和创意领域表现出色。考虑从事创业、公共关系、活动策划或创意艺术，这些领域你可以利用你的热情和激励他人的能力。",
      "friendshipCompatibility": "你形成许多友谊，以让他人感到特别和被理解的能力而闻名。你更喜欢深刻、有意义的联系，并投资于感觉真实的关系。你最舒适与欣赏你能量并能够支持你情感需求的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求深刻的情感联系和智力刺激。你重视能够理解你复杂情感并欣赏你热情本质的伴侣。你最适合与能够提供情感稳定性同时鼓励你创造力和热情的类型相处。",
      "mentalHealthInsights": "你的敏感性和高能量有时会导致情感压倒和因承担太多项目而产生的压力。你可能会经历例行公事和结构的困难。练习自我照顾并学会说不是很重要的。考虑帮助你管理能量和维持情感平衡的技巧。",
      "selfImprovement": "专注于发展实用技能并学会履行承诺。练习设定界限和有效管理你的时间。学会平衡你对多样性的需求与一致性的好处。考虑发展允许你以结构化方式表达创造力的爱好。",
      "coreAnalysisPreview": "你的ENFP人格类型代表了最热情和创新的组合之一，结合了自然魅力和创新思维。你拥有与人们在深刻层次联系的卓越能力，经常激励他们看到他们没有考虑过的可能性。你的创造精神允许你从独特角度处理问题，而你的热情使你成为一个自然的激励者，能够团结他人围绕新想法。在专业环境中，你通常是能够为项目带来能量和创造力的人，激励团队跳出框框思考并追求创新解决方案。你的自然人际交往技能使你在任何需要建立关系、激励他人或开发以人为中心的问题创意解决方案的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ENFP人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "竞选者 - 热情的创新者",
      "summary": "作为ENFP，你是一个热情和富有创造力的人，对生活有著传染性的热情。你与人联系和到处看到可能性的能力使你成为一个自然的激励者和创新者。",
  ...
  "ISTJ": {
    ...
    "zh-CN": {
      "title": "后勤学家 - 实用的组织者",
      "summary": "作为ISTJ，你是一个可靠和实用的人，具有卓越的组织技能。你对细节的关注和对传统的承诺使你成为一个自然的规划者和执行者，可以依靠你来完成事情。",
      "keyInsights": [
        "具有卓越细节关注的可靠组织者",
        "重视传统和秩序的实用规划者",
        "完成事情的自然执行者"
      ],
      "careerPath": "你的组织技能和对细节的关注使你很适合需要精确性和可靠性的职位。在会计、项目管理、行政和质量控制方面表现出色。考虑从事金融、运营、物流或政府工作，这些领域你可以利用你创造秩序和维持高标准的能力。",
      "friendshipCompatibility": "你与欣赏你可靠性并尊重你对秩序需求的人建立忠诚、持久的友谊。你更重视质量而不是数量，并深深投资于感觉稳定的关系。你最舒适与理解你实用本质并能够尊重你界限的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求稳定性和承诺。你重视可靠并能够欣赏你对生活实用方法的伴侣。你最适合与能够提供情感支持同时尊重你对结构和例行公事需求的类型相处。",
      "mentalHealthInsights": "你对秩序和控制的需求有时会在事情感觉混乱或不可预测时导致压力。你可能会经历变化和灵活性的困难。练习适应性并认识到不是所有事情都能被控制是很重要的。考虑帮助你管理不确定性和维持情感平衡的技巧。",
      "selfImprovement": "专注于发展灵活性并学会更容易地适应变化。练习表达你的情感并在更深层次与他人联系。学会平衡你对秩序的需求与对不完美的接受。考虑发展允许你更自发和创造性的爱好。",
      "coreAnalysisPreview": "你的ISTJ人格类型代表了最可靠和实用的组合之一，结合了自然组织技能和对质量的强烈承诺。你拥有从混乱中创造秩序的卓越能力，经常通过你对细节的关注和可靠的执行成为组织和项目的支柱。你的实用本质允许你识别问题的有效解决方案，而你对传统的承诺在不断变化的世界中提供稳定性和一致性。在专业环境中，你通常是能够依靠按时和预算内交付结果的人，维持高标准并确保没有遗漏。你的自然组织能力使你在任何需要精确性、可靠性和创造和维持秩序能力的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ISTJ人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "后勤学家 - 实用的组织者",
      "summary": "作为ISTJ，你是一个可靠和实用的人，具有卓越的组织技能。你对细节的关注和对传统的承诺使你成为一个自然的规划者和执行者，可以依靠你来完成事情。",
  ...
  "ESFJ": {
    ...
    "zh-CN": {
      "title": "领事 - 关怀的支持者",
      "summary": "作为ESFJ，你是一个温暖关怀的人，具有创造和谐和支持他人的自然天赋。你强烈的责任感和对他人需求的关注使你成为一个自然的照顾者和社区建设者。",
      "keyInsights": [
        "具有和谐自然天赋的温暖照顾者",
        "将他人放在首位的负责任支持者",
        "自然社区建设者和培育者"
      ],
      "careerPath": "你的关怀本质和组织技能使你很适合从事帮助和服务导向的职业。在医疗保健、教育、社会工作和客户服务方面表现出色。考虑从事护理、教学、人力资源或酒店业，这些领域你可以利用你照顾和支持他人的能力。",
      "friendshipCompatibility": "你形成许多友谊，以你的忠诚和帮助他人的意愿而闻名。你更喜欢亲密、支持性的关系，并深深投资于你关心的人。你最舒适与欣赏你关怀本质并能够回报你支持的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求稳定性和情感联系。你重视忠诚并能够欣赏你关怀本质的伴侣。你最适合与能够提供情感支持同时尊重你对承诺和家庭价值观需求的类型相处。",
      "mentalHealthInsights": "你将他人放在首位的倾向有时会导致忽视自己的需求和经历倦怠。你可能会因试图取悦每个人而经历压力。练习自我照顾和设定健康界限是很重要的。考虑帮助你优先考虑自己幸福的技巧。",
      "selfImprovement": "专注于发展自我照顾实践并学会在必要时说不。练习设定界限和表达你自己的需求。学会平衡你帮助他人的愿望与照顾自己的需求。考虑发展允许你专注于自己兴趣和放松的爱好。",
      "coreAnalysisPreview": "你的ESFJ人格类型代表了最关怀和支持的组合之一，结合了自然同理心和强烈的组织技能。你拥有理解和回应他人需求的卓越能力，经常通过你的关怀本质和对细节的关注成为家庭、工作场所和社区的情感支柱。你强烈的责任感驱使你确保周围的每个人都感到被支持和关怀，而你的组织能力允许你创建促进和谐和效率的系统和例行公事。在专业环境中，你通常是能够创造积极工作环境并确保客户和同事都感到被重视和支持的人。你的自然照顾能力使你在任何涉及支持他人、建立关系或创造和谐环境的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ESFJ人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "领事 - 关怀的支持者",
      "summary": "作为ESFJ，你是一个温暖关怀的人，具有创造和谐和支持他人的自然天赋。你强烈的责任感和对他人需求的关注使你成为一个自然的照顾者和社区建设者。",
  ...
  "ESTP": {
    ...
    "zh-CN": {
      "title": "企业家 - 大胆的冒险家",
      "summary": "作为ESTP，你是一个充满活力和实用的人，具有在当下采取行动和解决问题的自然天赋。你的适应性和动手方法使你成为一个自然的问题解决者，在快节奏的环境中茁壮成长。",
      "keyInsights": [
        "具有自然行动导向的动态问题解决者",
        "在兴奋中茁壮成长的适应性冒险家",
        "对挑战的实用动手方法"
      ],
      "careerPath": "你的实用技能和即兴思考能力使你很适合行动导向和动手的职业。在销售、紧急服务、体育和技术领域表现出色。考虑从事创业、执法、建筑或娱乐，这些领域你可以利用你快速适应和实时解决问题的能力。",
      "friendshipCompatibility": "你容易形成友谊，以你的能量和娱乐能力而闻名。你更喜欢活跃、令人兴奋的关系，并享受与分享你冒险感的人共度时光。你最舒适与欣赏你自发性并能够跟上你能量的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求兴奋和身体联系。你重视冒险并能够欣赏你自发本质的伴侣。你最适合与能够提供情感稳定性同时鼓励你冒险和娱乐感的类型相处。",
      "mentalHealthInsights": "你对兴奋和行动的需求有时会导致冲动性和长期规划的困难。你可能会因例行公事和结构而经历压力。练习耐心和发展长期思维是很重要的。考虑帮助你平衡即时满足与长期目标的技巧。",
      "selfImprovement": "专注于发展耐心并学会长期思考。练习规划和履行承诺。学会平衡你对兴奋的需求与稳定性的好处。考虑发展允许你以建设性方式引导能量的爱好。",
      "coreAnalysisPreview": "你的ESTP人格类型代表了最动态和行动导向的组合之一，结合了自然适应性和实用问题解决技能。你拥有即兴思考和快速回应变化情况的卓越能力，经常作为快节奏环境中即时问题解决的首选人。你的动手方法允许你通过直接经验学习并基于实时反馈调整你的策略，而你的自然能量使你成为一个自然的激励者，能够激励他人采取行动。在专业环境中，你通常是能够有效处理危机并通过你看到需要做什么并立即采取行动的能力找到复杂问题实用解决方案的人。你的自然问题解决能力使你在任何需要快速思考、适应性和实时解决问题能力的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ESTP人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "企业家 - 大胆的冒险家",
      "summary": "作为ESTP，你是一个充满活力和实用的人，具有在当下采取行动和解决问题的自然天赋。你的适应性和动手方法使你成为一个自然的问题解决者，在快节奏的环境中茁壮成长。",
  ...
  "ISFP": {
    ...
    "zh-CN": {
      "title": "冒险家 - 艺术探索者",
      "summary": "作为ISFP，你是一个温和和艺术的人，对美有深刻的欣赏，热爱和平的体验。你的敏感性和创造力使你成为一个自然的艺术家和治疗师，重视真实性和和谐。",
      "keyInsights": [
        "对美有深刻欣赏的温和艺术家",
        "重视和平体验的创意探索者",
        "重视真实性的自然治疗师"
      ],
      "careerPath": "你的艺术天赋和关怀本质使你很适合从事创意和帮助他人的职业。在视觉艺术、设计、咨询和医疗保健方面表现出色。考虑从事平面设计、摄影、治疗、护理或环境工作，这些领域你可以利用你的创造力和帮助他人的愿望。",
      "friendshipCompatibility": "你与欣赏你温和本质和艺术敏感性的人建立深刻、有意义的友谊。你更重视质量而不是数量，并投资于感觉真实的关系。你最舒适与尊重你独处需求并理解你情感深度的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求深刻的情感联系和共同的价值观。你重视能够理解你敏感本质并欣赏你艺术精神的伴侣。你最适合与能够提供情感支持同时尊重你对独立性和创意表达需求的类型相处。",
      "mentalHealthInsights": "你的敏感性和理想主义有时会导致情感压倒和来自冲突或批评的压力。你可能会经历对抗和高期望的困难。练习自我照顾和发展健康的应对机制是很重要的。考虑帮助你管理压力和维持情感平衡的技巧。",
      "selfImprovement": "专注于发展信心并学会更自信地表达你的需求。练习设定界限并在必要时为自己站出来。学会平衡你对和谐的需求与自我倡导的重要性。考虑发展允许你表达创造力并与自然联系的爱好。",
      "coreAnalysisPreview": "你的ISFP人格类型代表了最艺术和敏感的组合之一，结合了自然创造力和深度同理心。你拥有在世界上看到美并创造触动他人情感层面的有意义艺术表达的卓越能力。你的温和本质允许你为他人创造治愈和成长的安全空间，而你的艺术天赋为你提供与周围世界沟通和联系的独特方式。在专业环境中，你通常是能够为项目带来美和和谐的人，创造对他人感觉欢迎和鼓舞的环境。你的自然治愈能力使你在任何涉及帮助他人、创造美或促进情感幸福的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ISFP人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "冒险家 - 艺术探索者",
      "summary": "作为ISFP，你是一个温和和艺术的人，对美有深刻的欣赏，热爱和平的体验。你的敏感性和创造力使你成为一个自然的艺术家和治疗师，重视真实性和和谐。",
  ...
  "ENFJ": {
    ...
    "zh-CN": {
      "title": "主角 - 鼓舞人心的领导者",
      "summary": "作为ENFJ，你是一个有魅力和鼓舞人心的人，具有激励他人和创造积极变化的自然天赋。你的同理心和强烈的沟通技能使你成为一个自然的领导者和导师，能够激发人们最好的一面。",
      "keyInsights": [
        "具有自然激励能力的魅力领导者",
        "激励积极变化的同理心导师",
        "激发他人最好一面的自然沟通者"
      ],
      "careerPath": "你的领导技能和激励他人的能力使你很适合涉及领导团队和创造积极变化的职位。在管理、教学、咨询和公共关系方面表现出色。考虑从事教育、人力资源、非营利领导或咨询，这些领域你可以利用你激励和指导他人的能力。",
      "friendshipCompatibility": "你形成许多友谊，以让他人感到被重视和被理解的能力而闻名。你更喜欢深刻、有意义的联系，并投资于允许你帮助他人成长的关系。你最舒适与欣赏你关怀本质并能够回报你支持的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求深刻的情感联系和共同的价值观。你重视能够理解你复杂情感并欣赏你关怀本质的伴侣。你最适合与能够提供情感支持同时尊重你对独立性和个人成长需求的类型相处。",
      "mentalHealthInsights": "你将他人放在首位的倾向有时会导致忽视自己的需求和经历倦怠。你可能会因试图取悦每个人而经历压力。练习自我照顾和设定健康界限是很重要的。考虑帮助你优先考虑自己幸福的技巧。",
      "selfImprovement": "专注于发展自我照顾实践并学会在必要时说不。练习设定界限和表达你自己的需求。学会平衡你帮助他人的愿望与照顾自己的需求。考虑发展允许你专注于自己兴趣和放松的爱好。",
      "coreAnalysisPreview": "你的ENFJ人格类型代表了最鼓舞人心和同理心的领导组合之一，结合了自然魅力和对人性的深刻理解。你拥有看到他人潜力并激励他们达到他们从未想过的高度的卓越能力。你的自然沟通技能允许你与人们在深刻层次联系，而你的同理心使你能够理解并回应他们的需求，以促进成长和积极变化的方式。在专业环境中，你通常是能够激发团队最好一面的人，创造人们感到被激励、支持和鼓舞实现目标的环境。你的自然领导能力使你在任何涉及激励他人、建立关系或创造积极组织变化的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ENFJ人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "主角 - 鼓舞人心的领导者",
      "summary": "作为ENFJ，你是一个有魅力和鼓舞人心的人，具有激励他人和创造积极变化的自然天赋。你的同理心和强烈的沟通技能使你成为一个自然的领导者和导师，能够激发人们最好的一面。",
  ...
  "ENTP": {
    ...
    "zh-CN": {
      "title": "辩论家 - 创新思考者",
      "summary": "作为ENTP，你是一个杰出和创新的思考者，具有挑战假设和找到创意解决方案的自然天赋。你的机智和适应性使你成为一个自然的问题解决者，在智力刺激中茁壮成长。",
      "keyInsights": [
        "具有自然辩论技能的杰出创新者",
        "挑战假设的适应性问题解决者",
        "在智力刺激中茁壮成长的创意思考者"
      ],
      "careerPath": "你的创新思维和适应性使你很适合需要创造力和问题解决的职位。在创业、咨询、研究和创意领域表现出色。考虑从事业务发展、创新咨询、产品开发或创意艺术，这些领域你可以利用你跳出框框思考的能力。",
      "friendshipCompatibility": "你容易形成友谊，以你的机智和进行刺激讨论的能力而闻名。你更喜欢智力联系，并享受与能够挑战你思维的人共度时光。你最舒适与欣赏你创造力并能够跟上你能量的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求智力刺激和兴奋。你重视智力刺激并能够欣赏你创新思维的伴侣。你最适合与能够提供情感支持同时鼓励你创造力和智力成长的类型相处。",
      "mentalHealthInsights": "你对智力刺激的需求有时会导致不安和例行公事的困难。你可能会因感到无聊或缺乏挑战而经历压力。练习耐心和发展一致性是很重要的。考虑帮助你管理不安和维持专注的技巧。",
      "selfImprovement": "专注于发展一致性并学会履行承诺。练习耐心并发展支持你目标的例行公事。学会平衡你对多样性的需求与稳定性的好处。考虑发展允许你以结构化方式引导创造力的爱好。",
      "coreAnalysisPreview": "你的ENTP人格类型代表了最创新和智力刺激的组合之一，结合了自然创造力和卓越的分析思维。你拥有从多个角度看待问题并开发其他人可能错过的创意解决方案的卓越能力。你的自然辩论技能允许你挑战假设并探索新的可能性，而你的适应性使你能够基于新信息快速调整你的策略。在专业环境中，你通常是能够为项目带来新视角的人，激励团队创造性思考并考虑挑战的创新方法。你的自然问题解决能力使你在任何需要创意思考、战略规划或开发复杂问题创新解决方案能力的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ENTP人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "辩论家 - 创新思考者",
      "summary": "作为ENTP，你是一个杰出和创新的思考者，具有挑战假设和找到创意解决方案的自然天赋。你的机智和适应性使你成为一个自然的问题解决者，在智力刺激中茁壮成长。",
  ...
  "ESTJ": {
    ...
    "zh-CN": {
      "title": "执行官 - 高效组织者",
      "summary": "作为ESTJ，你是一个实用和有组织的人，具有卓越的领导技能和完成事情的强烈承诺。你的可靠性和对细节的关注使你成为一个自然的经理，能够创建高效系统并领导团队走向成功。",
      "keyInsights": [
        "具有卓越组织技能的实用领导者",
        "重视结构和秩序的高效经理",
        "通过团队合作获得结果的自然执行者"
      ],
      "careerPath": "你的组织技能和领导能力使你很适合管理和行政职位。在商业、政府、军事和运营方面表现出色。考虑从事项目管理、运营管理、行政或执行领导，这些领域你可以利用你创建秩序和有效领导团队的能力。",
      "friendshipCompatibility": "你与欣赏你可靠性并尊重你对秩序需求的人建立忠诚、持久的友谊。你更重视质量而不是数量，并深深投资于感觉稳定的关系。你最舒适与理解你实用本质并能够尊重你界限的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求稳定性和承诺。你重视可靠并能够欣赏你对生活实用方法的伴侣。你最适合与能够提供情感支持同时尊重你对结构和例行公事需求的类型相处。",
      "mentalHealthInsights": "你对秩序和控制的需求有时会在事情感觉混乱或不可预测时导致压力。你可能会经历变化和灵活性的困难。练习适应性并认识到不是所有事情都能被控制是很重要的。考虑帮助你管理不确定性和维持情感平衡的技巧。",
      "selfImprovement": "专注于发展灵活性并学会更容易地适应变化。练习表达你的情感并在更深层次与他人联系。学会平衡你对秩序的需求与对不完美的接受。考虑发展允许你更自发和创造性的爱好。",
      "coreAnalysisPreview": "你的ESTJ人格类型代表了最高效和有组织的领导组合之一，结合了自然管理技能和对结果的强烈承诺。你拥有从混乱中创造秩序的卓越能力，经常通过你对细节的关注和可靠的执行成为组织和项目的支柱。你的实用本质允许你识别问题的有效解决方案，而你对结构的承诺在不断变化的世界中提供稳定性和一致性。在专业环境中，你通常是能够依靠按时和预算内交付结果的人，维持高标准并确保没有遗漏。你的自然组织能力使你在任何需要强有力领导、高效运营和创造和维持秩序能力的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ESTJ人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "执行官 - 高效组织者",
      "summary": "作为ESTJ，你是一个实用和有组织的人，具有卓越的领导技能和完成事情的强烈承诺。你的可靠性和对细节的关注使你成为一个自然的经理，能够创建高效系统并领导团队走向成功。",
  ...
  "ISFJ": {
    ...
    "zh-CN": {
      "title": "守卫者 - 培育保护者",
      "summary": "作为ISFJ，你是一个温暖关怀的人，具有强烈的责任感和帮助他人的奉献精神。你对细节的关注和对传统的承诺使你成为一个自然的照顾者和保护者，创造安全、培育的环境。",
      "keyInsights": [
        "具有强烈保护本能的温暖照顾者",
        "重视传统和稳定性的奉献帮助者",
        "创造安全环境的自然培育者"
      ],
      "careerPath": "你的关怀本质和对细节的关注使你很适合从事帮助和服务导向的职业。在医疗保健、教育、社会工作和客户服务方面表现出色。考虑从事护理、教学、咨询或人力资源，这些领域你可以利用你照顾和支持他人的能力。",
      "friendshipCompatibility": "你与欣赏你关怀本质并尊重你对稳定性需求的人建立深刻、忠诚的友谊。你更重视质量而不是数量，并深深投资于感觉安全的关系。你最舒适与理解你保护本能并能够回报你支持的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求稳定性和情感联系。你重视忠诚并能够欣赏你关怀本质的伴侣。你最适合与能够提供情感支持同时尊重你对承诺和家庭价值观需求的类型相处。",
      "mentalHealthInsights": "你将他人放在首位的倾向有时会导致忽视自己的需求和经历倦怠。你可能会因试图取悦每个人而经历压力。练习自我照顾和设定健康界限是很重要的。考虑帮助你优先考虑自己幸福的技巧。",
      "selfImprovement": "专注于发展自我照顾实践并学会在必要时说不。练习设定界限和表达你自己的需求。学会平衡你帮助他人的愿望与照顾自己的需求。考虑发展允许你专注于自己兴趣和放松的爱好。",
      "coreAnalysisPreview": "你的ISFJ人格类型代表了最关怀和保护的组合之一，结合了自然同理心和强烈的组织技能。你拥有理解和回应他人需求的卓越能力，经常通过你的关怀本质和对细节的关注成为家庭、工作场所和社区的情感支柱。你强烈的责任感驱使你确保周围的每个人都感到安全和被支持，而你的组织能力允许你创建促进和谐和效率的系统和例行公事。在专业环境中，你通常是能够创造积极工作环境并确保客户和同事都感到被重视和支持的人。你的自然照顾能力使你在任何涉及支持他人、建立关系或创造安全和培育环境的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ISFJ人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "守卫者 - 培育保护者",
      "summary": "作为ISFJ，你是一个温暖关怀的人，具有强烈的责任感和帮助他人的奉献精神。你对细节的关注和对传统的承诺使你成为一个自然的照顾者和保护者，创造安全、培育的环境。",
  ...
  "ISTP": {
    ...
    "zh-CN": {
      "title": "艺术家 - 实用机械师",
      "summary": "作为ISTP，你是一个实用和分析的人，具有卓越的问题解决技能和对动手工作的热爱。你的适应性和对细节的关注使你成为一个自然的故障排除者，几乎可以修复任何东西。",
      "keyInsights": [
        "具有卓越机械技能的实用问题解决者",
        "热爱动手工作的适应性故障排除者",
        "几乎可以修复任何东西的自然分析师"
      ],
      "careerPath": "你的实用技能和问题解决能力使你很适合技术和动手职业。在工程、机械、技术和紧急服务方面表现出色。考虑从事汽车维修、IT支持、建筑或紧急响应，这些领域你可以利用你故障排除和修复问题的能力。",
      "friendshipCompatibility": "你基于共同兴趣和活动形成友谊。你更喜欢实用联系，并享受与分享你爱好的人共度时光。你最舒适与尊重你对独立需求并能够欣赏你实用本质的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求独立性和共同兴趣。你重视能够理解你对空间需求并欣赏你对生活实用方法的伴侣。你最适合与能够提供情感支持同时尊重你独立性的类型相处。",
      "mentalHealthInsights": "你对独立的需求有时会导致情感表达和承诺的困难。你可能会因感到被困或受控而经历压力。练习情感沟通和发展更深层次的联系是很重要的。考虑帮助你表达感受和建立亲密关系的技巧。",
      "selfImprovement": "专注于发展情商并学会更开放地表达你的感受。练习建立更深层次的联系和发展长期承诺。学会平衡你对独立的需求与情感联系的好处。考虑发展允许你在更深层次与他人联系的爱好。",
      "coreAnalysisPreview": "你的ISTP人格类型代表了最实用和分析的组合之一，结合了自然机械技能和卓越的问题解决能力。你拥有理解事物如何运作和识别技术问题有效解决方案的天生能力，经常作为个人和专业环境中故障排除和维修的首选人。你的动手方法允许你通过直接经验学习并基于实时反馈调整你的策略，而你的分析思维使你能够将复杂问题分解为可管理的组件。在专业环境中，你通常是能够有效处理技术危机并通过你看到需要做什么并立即采取行动的能力找到复杂问题实用解决方案的人。你的自然故障排除能力使你在任何需要技术专业知识、问题解决和动手工作能力的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ISTP人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "艺术家 - 实用机械师",
      "summary": "作为ISTP，你是一个实用和分析的人，具有卓越的问题解决技能和对动手工作的热爱。你的适应性和对细节的关注使你成为一个自然的故障排除者，几乎可以修复任何东西。",
  ...
  "ESFP": {
    ...
    "zh-CN": {
      "title": "表演者 - 自发的表演者",
      "summary": "作为ESFP，你是一个自发和充满活力的人，具有娱乐和与人联系的自然天赋。你的热情和人际交往技能使你成为一个自然的表演者和社交连接者，为他人带来快乐。",
      "keyInsights": [
        "具有自然人际交往技能的自发娱乐者",
        "热爱让他人快乐的充满活力的表演者",
        "为他人带来快乐的自然社交连接者"
      ],
      "careerPath": "你的人际交往技能和热情使你很适合涉及娱乐和人际联系的职位。在销售、酒店、娱乐和客户服务方面表现出色。考虑从事活动策划、旅游、表演艺术或公共关系，这些领域你可以利用你娱乐和与人联系的能力。",
      "friendshipCompatibility": "你形成许多友谊，以你的能量和让他人感觉良好的能力而闻名。你更喜欢活跃、社交的关系，并享受与分享你对生活热情的人共度时光。你最舒适与欣赏你自发性并能够跟上你能量的朋友相处。",
      "romanticCompatibility": "在恋爱关系中，你寻求兴奋和情感联系。你重视有趣并能够欣赏你自发本质的伴侣。你最适合与能够提供情感支持同时鼓励你娱乐和冒险感的类型相处。",
      "mentalHealthInsights": "你对兴奋和社交互动的需求有时会导致例行公事和长期规划的困难。你可能会因感到无聊或孤立而经历压力。练习耐心和发展一致性是很重要的。考虑帮助你管理不安和维持专注的技巧。",
      "selfImprovement": "专注于发展一致性并学会履行承诺。练习耐心并发展支持你目标的例行公事。学会平衡你对多样性的需求与稳定性的好处。考虑发展允许你以建设性方式引导能量的爱好。",
      "coreAnalysisPreview": "你的ESFP人格类型代表了最娱乐和社交参与的组合之一，结合了自然魅力和卓越的人际交往技能。你拥有读懂人们情感并以让他们感到被重视和娱乐的方式回应的天生能力，经常作为聚会的生命和能够通过你自然热情和社交魅力将人们聚集在一起的人。你的自发本质允许你快速适应变化的社交情况并为他人创造难忘的体验，而你的人际交往技能使你能够与各种各样的个人建立联系。在专业环境中，你通常是能够创造积极工作环境并确保客户和同事都感到受欢迎和娱乐的人。你的自然娱乐能力使你在任何涉及与人合作、创造积极体验或建立社交联系的领域都成为宝贵的资产。",
      "callToAction": "解锁你的完整ESFP人格分析，发现详细的职业策略、关系洞察、个人成长计划和专门为你独特优势和挑战量身定制的综合行动步骤。"
    },
    "zh_cn": {
      "title": "表演者 - 自发的表演者",
      "summary": "作为ESFP，你是一个自发和充满活力的人，具有娱乐和与人联系的自然天赋。你的热情和人际交往技能使你成为一个自然的表演者和社交连接者，为他人带来快乐。",
